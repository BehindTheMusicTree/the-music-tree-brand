...
function requireBuildConstant(name: string, value: string | undefined): string {
  if (!value) {
    throw new Error(`Missing required build constant: ${name}`);
  }
  return value;
}
...
const ENV_ROWS: BuildEnvRow[] = [
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_GITHUB_URL", ORG_GITHUB_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("GTMT_API_GITHUB_URL", GTMT_API_GITHUB_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_PYPI_URL", ORG_PYPI_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_LINKEDIN_URL", ORG_LINKEDIN_URL),
  ...
  },
  {
    ...
    usage: "X social link",
    keyName: "ORG_X_URL",
    keyValue: requireBuildConstant("ORG_X_URL", ORG_X_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_MASTODON_URL", ORG_MASTODON_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_YOUTUBE_URL", ORG_YOUTUBE_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_SPOTIFY_URL", ORG_SPOTIFY_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_DISCORD_URL", ORG_DISCORD_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("ORG_TIPEEE_URL", ORG_TIPEEE_URL),
  ...
  },
  {
    ...
    keyValue: requireBuildConstant("CONTACT_EMAIL", CONTACT_EMAIL),
